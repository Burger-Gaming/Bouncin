...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["Not a Singular Miss",			"Beat Egg Week on Hard with no Misses.",				false],
		["HowToBasic",					"vegan turkey",											false],
		['Crack and Justice',			"hi guy can you see me helloooooo",						 true],
		["Singular Miss",			"Beat Egg Week on Hard with only 1 Miss.",					false],
		['Meth and Mastery',			"First you go outside-",								false]
	];
	...
	public static var achievementsUnlocked:Array<Dynamic> = [ //Save string and Achievement tag + is it unlocked?
		...
		['howtobasic', false],			//17
		['hello', false],				//18
		['egg_onemiss', false],			//19
		['weed_nomiss', false]			//20
	];
